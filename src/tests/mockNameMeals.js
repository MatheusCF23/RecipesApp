...
const minced = 'Minced Beef';
const spring = 'Spring Onions';
const garlic = 'Garlic Clove';
const finaly = '1 finely chopped ';
const vegetable = 'Vegetable Oil';
